#ifndef __CMT2300drive__
  #define __CMT2300drive__
...
#define GPO3In()  PC_DDR&=~0x01  //   GPIO_Init(GPIO_PORT_D, (GPIO_Pin_TypeDef)GPIO2, GPIO_MODE_IN_FL_NO_IT)
#define GPO3IT()  PC_CR2|=0x01  // interrupt open  
#define GPO3_H() 	(((PC_IDR&0x01)==0x01) ? 1 : 0)   //(GPIO_ReadInputPin(GPIO_PORT_D,GPIO2) ? 1 : 0)
#define GPO3_L()  (((PC_IDR&0x01)==0x00) ? 1 : 0)  //(GPIO_ReadInputPin(GPIO_PORT_D,GPIO2) ? 0 : 1 )
#define GPO3IT_DIS()  PC_CR2&=~0x01;  // interrupt open  jia???????
